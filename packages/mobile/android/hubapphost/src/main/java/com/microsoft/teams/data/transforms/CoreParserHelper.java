...
package com.microsoft.teams.data.transforms;
...
//import com.microsoft.teams.models.ChatMessageResponse;
//import com.microsoft.teams.models.ConversationResponse;
//import com.microsoft.teams.models.ListModel;
//import com.microsoft.teams.models.RecordingPermissionsAndSettings;
//import com.microsoft.teams.models.TenantInfo;
//import com.microsoft.teams.models.TypingUser;
//import com.microsoft.teams.models.UserAggregatedSettings;
//import com.microsoft.teams.models.UserGroupsSettings;
//import com.microsoft.teams.models.VoiceAdminSettings;
//import com.microsoft.teams.services.authorization.IAccountManager;
//import com.microsoft.teams.services.authorization.helpers.CoreAuthorizationUtilities;
//import com.microsoft.teams.services.utilities.StringUtilities;
//import com.microsoft.teams.storage.CallRecordingDetails;
//import com.microsoft.teams.storage.IExperimentationManager;
//import com.microsoft.teams.storage.ITransaction;
//import com.microsoft.teams.storage.MessagePropertyType;
//import com.microsoft.teams.storage.RunnableOf;
//import com.microsoft.teams.storage.SkypeDBTransactionManager;
//import com.microsoft.teams.storage.ThreadType;
//import com.microsoft.teams.storage.dao.chatconversation.ChatConversationDao;
//import com.microsoft.teams.storage.dao.giphydefinition.GiphyDefinitionDao;
//import com.microsoft.teams.storage.dao.messagepropertyattribute.MessagePropertyAttributeDao;
//import com.microsoft.teams.storage.dao.messagesyncstate.MessageSyncStateDao;
//import com.microsoft.teams.storage.dao.user.UserDao;
import com.microsoft.teams.storage.tables.AppDefinition;
//import com.microsoft.teams.storage.tables.ChatAppDefinition;
//import com.microsoft.teams.storage.tables.ChatConversation;
//import com.microsoft.teams.storage.tables.Conversation;
//import com.microsoft.teams.storage.tables.GiphyDefinition;
//import com.microsoft.teams.storage.tables.Message;
//import com.microsoft.teams.storage.tables.MessagePropertyAttribute;
//import com.microsoft.teams.storage.tables.MessageSyncState;
import com.microsoft.teams.storage.tables.TeamEntitlement;
//import com.microsoft.teams.storage.tables.User;
//import com.microsoft.teams.storage.tables.UserEntitlement;
//import com.microsoft.teams.utilities.CoreConversationUtilities;
//import com.microsoft.teams.utilities.StringConstants;
...
//import static com.microsoft.teams.util.CallConstants.RECORDING_EXPIRED;
//import static com.microsoft.teams.util.CallConstants.RECORDING_READY_ONLY_IN_AMS;
//import static com.microsoft.teams.util.CallConstants.RECORDING_STORAGE_TYPE_ONEDRIVEFORBUSINESS;
//import static com.microsoft.teams.util.CallConstants.RECORDING_STORAGE_TYPE_STREAM;
...
public abstract class CoreParserHelper {
    ...
    private static final String TAG = com.microsoft.teams.data.transforms.CoreParserHelper.class.getSimpleName();
