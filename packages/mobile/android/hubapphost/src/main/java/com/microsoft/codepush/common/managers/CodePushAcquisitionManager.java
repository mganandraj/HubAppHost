...
public class CodePushAcquisitionManager {
     ...
     */
    final private static String REPORT_DOWNLOAD_STATUS_ENDPOINT = "v0.1/legacy/reportStatus/download";

    /**
     * Endpoint for sending {@link CodePushDeploymentStatusReport}.
     */
    final private static String REPORT_DEPLOYMENT_STATUS_ENDPOINT = "v0.1/legacy/reportStatus/deploy";

    /**
     * Query updates string pattern.
     */
    final private static String UPDATE_CHECK_ENDPOINT = "v0.1/legacy/updateCheck?%s";
