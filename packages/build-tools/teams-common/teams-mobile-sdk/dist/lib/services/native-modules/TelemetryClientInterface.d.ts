...
export interface TelemetryClientInterface extends EventSubscriptionVendor {
     ...
     */
    logUserBIEvent(event: UserBIEvent): any;
    /**
     * Start a scenario
     *
     ...
     * @memberof TelemetryClientInterface
     */
    startScenario(scenarioName: string, databag: {
     ...
     * @memberof TelemetryClientInterface
     */
    startScenarioUnderParent(scenarioName: string, parentScenarioId: string, databag: {
        [key: string]: string | number | boolean;
    } | null): Promise<string>;
    /**
     ...
     * @memberof TelemetryClientInterface
     */
    endScenarioChainOnError(scenarioId: string, scenarioErrorCode: string, scenarioErrorReason: string, databag: {
        [key: string]: string | number | boolean;
    } | null): any;
    /**
     ...
     * @memberof TelemetryClientInterface
     */
    endScenarioOnError(scenarioId: string, scenarioErrorCode: string, scenarioErrorReason: string, databag: {
        [key: string]: string | number | boolean;
    } | null): any;
    /**
     ...
     * @memberof TelemetryClientInterface
     */
    endScenarioChainOnIncomplete(scenarioId: string, scenarioErrorCode: string, scenarioErrorReason: string, databag: {
        [key: string]: string | number | boolean;
    } | null): any;
    /**
     ...
     * @memberof TelemetryClientInterface
     */
    endScenarioOnIncomplete(scenarioId: string, scenarioErrorCode: string, scenarioErrorReason: string, databag: {
        [key: string]: string | number | boolean;
    } | null): any;
    /**
     ...
     * @memberof TelemetryClientInterface
     */
    endScenarioChainOnCancel(scenarioId: string, scenarioErrorCode: string, scenarioErrorReason: string, databag: {
        [key: string]: string | number | boolean;
    } | null): any;
    /**
     ...
     * @memberof TelemetryClientInterface
     */
    endScenarioOnCancel(scenarioId: string, scenarioErrorCode: string, scenarioErrorReason: string, databag: {
        [key: string]: string | number | boolean;
    } | null): any;
    /**
     ...
     * @memberof TelemetryClientInterface
     */
    endScenarioOnSuccess(scenarioId: string, databag: {
        [key: string]: string | number | boolean;
    } | null): any;
    /**
     ...
     * @memberof TelemetryClientInterface
     */
    endScenarioChainOnSuccess(scenarioId: string, databag: {
        [key: string]: string | number | boolean;
    } | null): any;
    /**
     ...
     * @memberof TelemetryClientInterface
     */
    registerHandlerForPDCLevelChange(handler: (pdcLevel: UserPDCLevel) => void): any;
    /**
     * Removes the handler registered for PDC level change event
     */
    removeHandlerForPDCLevelChange(): any;
}
