...
// PresenceStatus equiv in Teamspace-iOS is TSPresenceStatus enum
// PresenceStatus equiv in SkypeSpace-Android is UserStatus enum
...
export interface PersonContactMetadata extends PersonIds {
   ...
   */
  contactMetadata?: { [name: string]: ContactCardItem[] };
}
