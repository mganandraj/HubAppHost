...
public abstract class CodePushBaseCore {
    ...
    public CodePushConfiguration getNativeConfiguration() throws CodePushNativeApiCallException {
        ...
        try {
            final String teamsAndroidIdKey = "Teams_FAKE_Android_Id_global";
            // final String androidId = Prefs.getString(teamsAndroidIdKey, null);
            ...
            // configuration.setClientUniqueId(androidId);
