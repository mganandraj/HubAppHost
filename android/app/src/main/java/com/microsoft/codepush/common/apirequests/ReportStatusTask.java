...
public class ReportStatusTask extends BaseHttpTask<CodePushReportStatusResult> {
    ...
    @Override
    public CodePushReportStatusResult call() throws Exception {
        ...
        try {
            ...
            if (failed) {
                mExecutionException = new CodePushReportStatusException(connection.getResponseCode() + ", " + result, mReportType);
                return null;
            } else {
